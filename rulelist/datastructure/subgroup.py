...
class Subgroup():
    ...
    def update(self, new_candidate, new_subgroup_statistics, new_default_rule_statistics, gain_data, gain_model, score):
        self.pattern = new_candidate
        self.statistics = deepcopy(new_subgroup_statistics)
        self.default_statistics = deepcopy(new_default_rule_statistics)
